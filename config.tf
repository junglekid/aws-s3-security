...
#   name     = "${var.aws_s3_bucket_name}-s3-bucket-configuration-recorder"
...
#   name = "${var.aws_s3_bucket_name}-s3-bucket-delivery-channel"

#   s3_bucket_name = "${var.aws_s3_bucket_name}-audit"
...
#   name               = "${var.aws_s3_bucket_name}-config-role"
...
#   name   = "${var.aws_s3_bucket_name}-aws-config-role"
...
#   name = "${var.aws_s3_bucket_name}-${each.key}-config-rule"
...
#   #   compliance_resource_id    = var.aws_s3_bucket_name
#   # }
